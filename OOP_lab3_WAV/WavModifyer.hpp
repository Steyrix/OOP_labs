...
private:
    static size_t getChanCount(const DataArray &soundData) throw (BAD_PARAMS_EXC);
    static size_t getSamplesPerChan(const DataArray &soundData) throw (BAD_PARAMS_EXC);
    ...
    static void checkChannels(DataArray& data) throw (BAD_PARAMS_EXC);
